<template>
  <transition name="el-zoom-in-top" @after-leave="$emit('dodestroy')">
    <div v-show="visible" class="el-picker-panel el-popper date-range-picker" :class="[{
      'has-sidebar': $slots.sidebar || shortcuts, 'has-time': showTime
    }, popperClass]">
      <div class="el-picker-panel__body-wrapper">
        <div class="main">
          <slot name="sidebarCustom" class="el-picker-panel__sidebar__custom"></slot>
          <slot name="sidebar" class="el-picker-panel__sidebar"></slot>
          <div class="el-picker-panel__sidebar" v-if="shortcuts">
            <button type="button" class="el-picker-panel__shortcut" v-for="(shortcut, key) in shortcuts" :key="key"
              @click="handleShortcutClick(shortcut)">{{ shortcut.text }}</button>
          </div>
          <div class="el-picker-panel__body el-picker-panel__body__dynamic" v-show="isDynamicDate">
            <slot name="dynamicDate"></slot>
            <slot name="pickerTop"></slot>
            <slot name="pickerBottom" class="el-picker-panel__bottom"></slot>
          </div>
          <div class="el-picker-panel__body" v-show="!isDynamicDate">
            <div class="body">
...
export default {
  ...
  methods: {
    ...
    handleRangePick(val, close = true) {
      ...
      this.handleConfirm(false, 'click')
    },
    ...
    handleConfirm(visible = false, clickType) {
      console.log('bin:543', { visible, clickType })
      if (this.isValidValue([this.minDate, this.maxDate])) {
        visible = clickType === 'click'
        this.$emit('pick', [this.minDate, this.maxDate], visible, clickType)
      }
    },
    handleCancel() {
      this.$emit('pick', [], false, 'cancel')
    },
